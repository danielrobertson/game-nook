        ...
        <div className="relative flex flex-col min-h-[600px] bg-[#5D4037]">
            ...
            <div 
                ...
                style={{
                  ...
                  // Trapezoid narrowing downwards
                  clipPath: 'polygon(0 0, 100% 0, 97% 100%, 3% 100%)',
                  filter: 'brightness(0.5)' // Darker because it's an inner surface
                }}
            >
                {/* Inner shadow */}
            ...
            <div 
                ...
                style={{
                   backgroundImage: woodTexture,
                   backgroundSize: '200px',
                   // Trapezoid narrowing rightwards
            ...
            */}
            <div 
                className="relative z-0 flex-1 flex flex-col"
                style={{
                    backgroundColor: '#8D6E63', // Dark Wood fallback
                    backgroundImage: `linear-gradient(rgba(0,0,0,0.1), rgba(0,0,0,0.1)), ${woodTexture}`,
                    backgroundSize: '200px',
                    ...
                    boxShadow: 'inset 0 0 40px rgba(0,0,0,0.3)', // Deeper inner shadow
                    filter: 'brightness(0.95)' // Slightly darker than outer frame
                }}
            >
                {/* Rows */}
      ...
      {!isBottom && (
        <div className="absolute bottom-0 left-[-2px] right-[-2px] z-20">
            ...
            >
             ...
             <div 
                className="h-[12px] relative shadow-lg"
                style={{
                    backgroundImage: woodTexture,
                    backgroundSize: '200px',
